...
class SearchAuthorsSource(private val apiService: ApiService, private val query: String) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, QuoteResult> {
        return try {
            ...
            val dataQuery = apiService.getSearchAuthors(query = query, page = nextPage)
